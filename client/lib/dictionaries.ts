...
export const dictionaries: Record<Locale, Dictionary> = {
  ru: {
    ...
    login: {
      ...
      title: "Вход в Toi Duman",
      text: "Войди по своему user ID и паролю, чтобы управлять шаблонами, заказами и приглашениями.",
      userId: "User ID",
      password: "Пароль",
      ...
      button: "Войти",
      loading: "Входим...",
      error: "Не удалось выполнить вход. Проверь user ID и пароль.",
  ...
  kk: {
    ...
    login: {
      ...
      title: "Toi Duman жүйесіне кіру",
      text: "Үлгілерді, тапсырыстарды және шақыруларды басқару үшін user ID мен құпиясөз арқылы кіріңіз.",
      userId: "User ID",
      password: "Құпиясөз",
      userIdPlaceholder: "cli-100001",
      ...
      button: "Кіру",
      loading: "Кіріп жатыр...",
      error: "Кіру мүмкін болмады. User ID мен құпиясөзді тексеріңіз.",
