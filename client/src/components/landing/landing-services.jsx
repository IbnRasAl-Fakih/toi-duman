...
const SERVICE_ITEMS = [
  {
    title: "Той",
    description: "Современные цифровые приглашения для казахских торжеств с уважением к традициям и семейному стилю.",
    icon: "rings",
  },
  {
    title: "Қыз ұзату",
    description: "Нежные и трогательные приглашения для проводов невесты с деликатной национальной эстетикой.",
    icon: "bride",
  },
  {
    title: "День рождения",
    description: "Тёплые и выразительные решения для юбилеев, семейных праздников и камерных вечеров.",
    icon: "cake",
  },
  {
    title: "Корпоратив",
    description: "Сдержанный и аккуратный формат для деловых мероприятий, закрытых ужинов и командных событий.",
    icon: "work",
  },
];
    ...
    <section className="mx-auto w-full max-w-[1240px] px-4 pb-20 pt-8 md:px-5 md:pb-24 md:pt-10">
      <div className="mx-auto max-w-[820px] text-center">
        ...
        <p className="mx-auto mt-4 max-w-[39rem] text-[1rem] leading-8 text-[#8b8c92]">
          Мы создаём цифровые приглашения для значимых поводов, сохраняя культурный код и современную подачу в одном
          визуальном языке.
        </p>
