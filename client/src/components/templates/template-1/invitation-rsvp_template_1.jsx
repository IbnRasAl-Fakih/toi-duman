export default function InvitationRsvpTemplate1({
  ...
  return (
    <section className="px-5 pb-14 pt-10 text-center md:px-7 md:pb-16 md:pt-12 lg:px-[9vw] lg:py-[88px]">
      <img src="/images/templates/template-1/roses-top.svg" alt="" className="mx-auto w-full max-w-[320px] md:max-w-[360px]" />
      ...
      <div className="mx-auto mt-7 max-w-[310px] md:max-w-[360px] lg:max-w-[760px]">
        <label className="block text-left">
          ...
          <input
            ...
            className="w-full rounded-[24px] border border-[#7f1118]/25 bg-white/60 px-5 py-4 text-lg text-[#7f1118] outline-none transition placeholder:text-[#7f1118]/35 focus:border-[#7f1118] focus:bg-white disabled:cursor-not-allowed disabled:opacity-50"
          />
        </label>
      </div>
      ...
      <div className="mx-auto mt-4 h-16 w-40 bg-contain bg-center bg-no-repeat" style={{ backgroundImage: "url('/icons/templates/template-1/line-heart.svg')" }} />
      <div className="mt-4 text-lg font-semibold uppercase tracking-[0.12em] md:text-[1.375rem]">{template.couple.signature}</div>
    </section>
  );
}
