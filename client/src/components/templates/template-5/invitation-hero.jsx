...
import { ScrollDownIcon } from "../../../assets/template-5/scroll-down-icon.jsx";
import { TapIcon } from "../../../assets/template-5/tap-icon.jsx";
  ...
  return (
    <section className="relative min-h-[100svh] overflow-hidden bg-[#fff9f5]" style={viewportHeight ? { minHeight: `${viewportHeight}px` } : undefined}>
      <div className="absolute inset-0 overflow-hidden bg-[#c07d6e]">
        {!isOpened ? (
          <img
            src="/images/templates/template-5/curtain-closed-Bpkadld4.jpg"
            alt=""
            aria-hidden="true"
        ...
        <video
          ...
          src="/images/templates/template-5/curtain-video-BAKLj3Y5.mp4"
          muted
          playsInline
          preload="auto"
          poster="/images/templates/template-5/curtain-open-C9MqdT6G.jpg"
          onEnded={() => {
            setIsFinished(true);
          }}
        />
