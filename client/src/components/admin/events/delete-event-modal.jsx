  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center px-4 py-6">
      ...
      <div className="relative w-full max-w-xl rounded-[32px] border border-black/10 bg-[#fffaf6] p-6 shadow-[0_28px_90px_rgba(31,24,21,0.18)] md:p-8">
        <p className="text-[11px] uppercase tracking-[0.34em] text-[#b42318]/60">Оқиғаны өшіру</p>
        <h2 className="mt-4 font-['Georgia','Times_New_Roman',serif] text-4xl leading-none text-[#7f1118]">
          Оқиғаны өшіру керек пе?
        </h2>
        <p className="mt-5 text-sm leading-7 text-black/65 md:text-base">
          <span className="font-medium text-[#1f1a17]">{event.slug}</span> оқиғасы, соған байланысты тапсырыс және Cloudflare-дегі мұқаба өшіріледі.
        </p>
        ...
        <div className="mt-7 flex flex-col-reverse gap-3 sm:flex-row sm:justify-end">
          ...
          >
            {isDeleting ? "Өшірілуде..." : "Өшіруді растау"}
          </button>
        </div>
      </div>
    </div>
