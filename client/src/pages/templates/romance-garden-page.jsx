...
export function mapEventToTemplate6(event, nowTimestamp = Date.now()) {
  ...
  const fallbackGallery = [
    ...
    {
      src: "/images/templates/romance-garden/swans-framed-ByH4RE7t.png",
      alt: "Жақтаудағы аққулар"
    },
    {
      src: "/images/templates/romance-garden/open6.png",
      alt: "Шақыру конверті"
    },
    {
      src: "/images/templates/romance-garden/venue-hedsor-DSq2yQw3.png",
      alt: "Өтетін орын иллюстрациясы"
    },
    {
      src: "/images/templates/romance-garden/eda6.png",
...
export default function RomanceGardenPage({ event, order }) {
