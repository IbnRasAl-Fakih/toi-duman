...
import InvitationTemplate6Page, { TEMPLATE_6_PATH, TEMPLATE_6_TYPE } from "./templates/invitation-page_template_6.jsx";
      ...
      <div className="relative mx-auto" style={{ height: `${phoneHeight}px`, width: `${phoneWidth}px` }}>
        ...
        >
          <div className="preview-scroll-hidden h-full overflow-x-hidden overflow-y-auto bg-[#f7f1e7]">
            ...
            >
              <InvitationTemplate6Page event={previewEvent} order={previewOrder} />
            </div>
          </div>
        </div>
...
export default function Template6FormPage() {
